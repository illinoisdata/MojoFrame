...
fn test_query_1() raises:
    ...
    var l_linestatus_arr = df['l_linestatus'].to_numpy()
    var l_tax_arr = df['l_tax'].to_numpy()
    ...
    for i in range(17996609):
        ...
        l_returnflag[i] = float(l_returnflag_arr[i])
        l_shipdate[i] = float(l_shipdate_arr[i])
        l_linestatus[i] = float(l_linestatus_arr[i])
        l_tax[i] = float(l_tax_arr[i])
    ...
    col_data.append(l_linestatus)
    col_data.append(l_tax)
    col_data.append(l_discprice)
    col_data.append(l_charge)

    var col1_name = "l_quantity"
    var col2_name = "l_extendedprice"
    var col3_name = "l_discount"
    var col4_name = "l_returnflag"
    var col5_name = "l_shipdate"
    var col6_name = "l_linestatus"
    var col7_name = "l_tax"
    var col8_name = "l_discprice"
    var col9_name = "l_charge"
    var col_names = List[String]()
    ...
    col_names.append(col8_name)
    col_names.append(col9_name)
...
fn test_query_3() raises:
    ...
    var l_quantity = Float64Array(17996609)
    var l_returnflag = Float64Array(17996609)
    var l_revenue = Float64Array(17996609)
    ...
    var col7_name = "l_revenue"

    var col_names = List[String](col1_name, col2_name, col3_name,
                                 col4_name, col5_name, col6_name, col7_name)
    ...
    for i in range(450000):
        c_custkey[i] = float(c_custkey_arr[i])
        c_mktsegment[i] = float(c_mktsegment_arr[i])
    ...
    # var df_m = pd.merge(left=df_cust, right=df_ord, how='inner', left_on='c_custkey',right_on='o_custkey')
    #var df_mm = pd.merge(left=df_m, right=df, how='inner', left_on='o_orderkey', right_on='l_orderkey')
    #print(df_m.head())

    # var filtered_df_new = df_m[
    #     #df_m['c_mktsegment'].isin([1.0]) &
    #     (df_m['o_orderdate'] < 794880000.0) &
    #     (df_m['l_shipdate'] > 794880000.0)
    # ]
    ...
    # df_lineitem.select("orderkey", "orderkey", EQPredF64(), EQPredF64(), 359.0, 359.0, "", indices)
    # for i in range(df_lineitem.columns[0].size):
    #     print("row: ", i)
    #     for j in range(df_lineitem.columns.size):
    #         print(df_lineitem[j][i])
    ...
    #var df_sums = joined_df.sum(0)

    # for i in range(df_sums.size):
    #     print(df_sums[i])
    ...
    # var df_mm = pd.read_csv('df_mm.csv')
    # print(df_mm.shape)
    # var price_arr = df_mm['o_orderkey'].to_numpy()
    # var price_arr_mojo = joined_df['orderkey']
    
    # for i in range(4500000):
    #     if not np.isin(price_arr_mojo[i], price_arr): 
    #         print("Price diff at index: ", i)
    #         for col in range(joined_df.columns.size):
    #             print("Current col :", joined_df.column_names[col])
    #             print("value: ", joined_df.columns[col][i])
    #         break

    # print(joined_df_final[0].size)
    # for i in range(joined_df.columns[0].size):
    #     print("row: ", i)
    #     for j in range(joined_df.columns.size):
    #         print(joined_df[j][i])
...
fn test_query_6() raises:
    ...
    var col1_name = "l_extendedprice"
    var col2_name = "l_discount"
    var col3_name = "l_shipdate"
...
fn test_query_4() raises:
    ...
    col_data.append(l_extendedprice)
    col_data.append(l_shipdate)
    col_data.append(l_commitdate)
    col_data.append(l_receiptdate)

    var col1_name = "orderkey"
    var col2_name = "l_quantity"
    var col3_name = "l_extendedprice"
    var col4_name = "l_shipdate"
    var col5_name = "l_commitdate"
    var col6_name = "l_receiptdate"
    ...
    orders_col_data.append(o_orderdate)
    orders_col_data.append(o_shippriority)
    orders_col_data.append(o_orderpriority)

    var orders_col1_name = "custkey"
    var orders_col2_name = "orderkey"
    var orders_col3_name = "o_orderdate"
    var orders_col4_name = "o_shippriority"
    var orders_col5_name = "o_orderpriority"
    ...
    orders_col_names.append(orders_col3_name)
    orders_col_names.append(orders_col4_name)
    orders_col_names.append(orders_col5_name)
...
#     col_data.append(l_discount)
#     col_data.append(l_discprice)
#     col_data.append(l_suppkey)

#     var col1_name = "orderkey"
#     var col2_name = "l_extendedprice"
#     var col3_name = "l_discount"
#     var col4_name = "l_discprice"
...
#     var cust_col_data = List[Float64Array]()
#     cust_col_data.append(c_custkey)
#     cust_col_data.append(c_nationkey)

#     var cust_col1_name = "custkey"
#     var cust_col2_name = "c_nationkey"
...
#     var supp_col_data = List[Float64Array]()
#     supp_col_data.append(s_suppkey)
#     supp_col_data.append(s_nationkey)

#     var supp_col1_name = "suppkey"
#     var supp_col2_name = "nationkey"
    
#     var supp_col_names = List[String]()
#     supp_col_names.append(supp_col1_name)
#     supp_col_names.append(supp_col2_name)
...
#     var nation_col_data = List[Float64Array]()
#     nation_col_data.append(n_nationkey)
#     nation_col_data.append(n_regionkey)
#     nation_col_data.append(n_name)

#     var nation_col1_name = "nationkey"
#     var nation_col2_name = "regionkey"
#     var nation_col3_name = "n_name"
    
#     var nation_col_names = List[String]()
#     nation_col_names.append(nation_col1_name)
#     nation_col_names.append(nation_col2_name)
#     nation_col_names.append(nation_col3_name)

#     var df_nation = DataFrameF64(nation_col_data, nation_col_names)


#     var file_path_region = 'region.csv'
...
#     var region_col_data = List[Float64Array]()
#     region_col_data.append(r_regionkey)
#     region_col_data.append(r_name)

#     var region_col1_name = "regionkey"
#     var region_col2_name = "r_name"
    
#     var region_col_names = List[String]()
#     region_col_names.append(region_col1_name)
#     region_col_names.append(region_col2_name)
...
#     var ps_col_data = List[Float64Array]()
#     ps_col_data.append(ps_partkey)
#     ps_col_data.append(ps_suppkey)
#     ps_col_data.append(ps_supplycost)

#     var ps_col1_name = "partkey"
#     var ps_col2_name = "suppkey"
#     var ps_col3_name = "ps_supplycost"
    
#     var ps_col_names = List[String]()
#     ps_col_names.append(ps_col1_name)
#     ps_col_names.append(ps_col2_name)
#     ps_col_names.append(ps_col3_name)

#     var df_partsupp = DataFrameF64(ps_col_data, ps_col_names)
#     # var df_partsupp_outer = DataFrameF64(ps_col_data, ps_col_names)

#     var file_path_part = 'part.csv'
...
#     var p_type_arr = df_pt['p_type'].to_numpy()
...
#     var part_col_data = List[Float64Array]()
#     part_col_data.append(p_partkey)
#     part_col_data.append(p_size)

#     var part_col1_name = "partkey"
#     var part_col2_name = "p_size"
    
#     var part_col_names = List[String]()
#     part_col_names.append(part_col1_name)
#     part_col_names.append(part_col2_name)
...
#     var s_suppkey_arr = df_supp['s_suppkey'].to_numpy()
#     var s_nationkey_arr = df_supp['s_nationkey'].to_numpy()
#     var s_acctbal_arr = df_supp['s_acctbal'].to_numpy()
#     var s_name_arr = df_supp['s_name'].to_numpy()

#     var s_suppkey = Float64Array(30000)
#     var s_nationkey = Float64Array(30000)
#     var s_acctbal = Float64Array(30000)
#     var s_name = Float64Array(30000)

#     for i in range(30000):
#         s_suppkey[i] = s_suppkey_arr[i].to_float64()
#         s_nationkey[i] = s_nationkey_arr[i].to_float64()
#         s_acctbal[i] = s_acctbal_arr[i].to_float64()
...
#     supp_col_data.append(s_suppkey)
#     supp_col_data.append(s_nationkey)
#     supp_col_data.append(s_acctbal)
#     supp_col_data.append(s_name)

#     var supp_col1_name = "suppkey"
#     var supp_col2_name = "nationkey"
#     var supp_col3_name = "s_acctbal"
#     var supp_col4_name = "s_name"
    
#     var supp_col_names = List[String]()
#     supp_col_names.append(supp_col1_name)
#     supp_col_names.append(supp_col2_name)
#     supp_col_names.append(supp_col3_name)
#     supp_col_names.append(supp_col4_name)
...
#     var nation_col1_name = "nationkey1"
#     var nation_col2_name = "n_name1"
...
#     var nation2_col1_name = "nationkey2"
#     var nation2_col2_name = "n_name2"
    
#     var nation2_col_names = List[String]()
#     nation2_col_names.append(nation2_col1_name)
#     nation2_col_names.append(nation2_col2_name)
...
#     var nation_col1_name = "nationkey1"
#     var nation_col2_name = "n_name1"
#     var nation_col3_name = "regionkey1"
...
#     var nation2_col1_name = "nationkey2"
#     var nation2_col2_name = "n_name2"
#     var nation2_col3_name = "regionkey2"
    
#     var nation2_col_names = List[String]()
#     nation2_col_names.append(nation2_col1_name)
#     nation2_col_names.append(nation2_col2_name)
#     nation2_col_names.append(nation2_col3_name)
...
#     var region_col1_name = "regionkey1"
#     var region_col2_name = "r_name"
...
#     var p_partkey_arr = df_pt['p_partkey'].to_numpy()
#     var p_name_arr = df_pt['p_name'].to_numpy()
...
#     var orders_col1_name = "orderkey"
#     var orders_col2_name = "o_orderdate"
...
#     cust_col_data.append(c_custkey)
#     cust_col_data.append(c_nationkey)
#     cust_col_data.append(c_acctbal)
...
#     cust_col_names.append(cust_col1_name)
#     cust_col_names.append(cust_col2_name)
#     cust_col_names.append(cust_col3_name)
...
#     ps_col_data.append(ps_suppkey)
#     ps_col_data.append(ps_supplycost)
#     ps_col_data.append(ps_availqty)
...
#     ps_col_names.append(ps_col2_name)
#     ps_col_names.append(ps_col3_name)
#     ps_col_names.append(ps_col4_name)
...
#     col_data.append(l_commitdate)
#     col_data.append(l_receiptdate)
#     col_data.append(l_shipmode)

#     var col1_name = "orderkey"
#     var col2_name = "l_shipdate"
#     var col3_name = "l_commitdate"
#     var col4_name = "l_receiptdate"
#     var col5_name = "l_shipmode"
...
#     var orders_col1_name = "orderkey"
#     var orders_col2_name = "o_orderpriority"
...
#     var o_custkey_arr = df_ord['o_custkey'].to_numpy()
#     var o_comment_arr = df_ord['o_comment'].to_numpy()
...
#     var supplier_col_data = List[Float64Array]()
#     supplier_col_data.append(s_suppkey)
#     supplier_col_data.append(s_name)
...
#     var s_suppkey_arr = df_supp['s_suppkey'].to_numpy()
#     var s_comment_arr = df_supp['s_comment'].to_numpy()
...
#     var p_size_arr = df_pt['p_size'].to_numpy()
#     var p_type_arr = df_pt['p_type'].to_numpy()
#     var p_brand_arr = df_pt['p_brand'].to_numpy()
...
#     var lineitem_col_data = List[Float64Array]()
#     lineitem_col_data.append(l_partkey)
#     lineitem_col_data.append(l_quantity)
#     lineitem_col_data.append(l_extendedprice)

#     var lineitem_col_names = List[String]()
#     lineitem_col_names.append("partkey")
#     lineitem_col_names.append("l_quantity")
#     lineitem_col_names.append("l_extendedprice")
...
#     var p_partkey_arr = df_pt['p_partkey'].to_numpy()
#     var p_brand_arr = df_pt['p_brand'].to_numpy()
#     var p_container_arr = df_pt['p_container'].to_numpy()
...
#     var o_orderkey_arr = df_ord['o_orderkey'].to_numpy()
#     var o_orderdate_arr = df_ord['o_orderdate'].to_numpy()
#     var o_totalprice_arr = df_ord['o_totalprice'].to_numpy()
#     var o_custkey_arr = df_ord['o_custkey'].to_numpy()
...
#     orders_col_data.append(o_orderkey)
#     orders_col_data.append(o_orderdate)
#     orders_col_data.append(o_totalprice)
#     orders_col_data.append(o_custkey)

#     var orders_col1_name = "orderkey"
#     var orders_col2_name = "o_orderdate"
#     var orders_col3_name = "o_totalprice"
#     var orders_col4_name = "custkey"
...
fn test_query_19() raises:
    ...
    var l_partkey_arr = df['l_partkey'].to_numpy()
    var l_shipmode_arr = df['l_shipmode'].to_numpy()
    var l_shipinstruct_arr = df['l_shipinstruct'].to_numpy()
    ...
    var col1_name = "l_extendedprice"
    var col2_name = "l_discount"
    var col3_name = "l_quantity"
    var col4_name = "partkey"
    var col5_name = "l_shipmode"
...
#     var col1_name = "partkey"
#     var col2_name = "l_quantity"
#     var col3_name = "l_suppkey"
#     var col4_name = "l_shipdate"
...
#     var supp_col1_name = "s_suppkey"
#     var supp_col2_name = "nationkey"
#     var supp_col3_name = "s_name"
...
#     var ps_col1_name = "partkey"
#     var ps_col2_name = "s_suppkey"
#     var ps_col3_name = "ps_availqty"
...
fn test_query_21() raises:
    ...
    var df_lineitem = DataFrameF64(col_data, col_names)
    var df_lineitem_late = DataFrameF64(col_data, List[String](col1_name, "suppkey_late", col3_name, col4_name))
    ...
    var o_orderstatus_arr = df_ord['o_orderstatus'].to_numpy()
    var o_orderkey_arr = df_ord['o_orderkey'].to_numpy()
    ...
    for i in range(4500000):
        o_orderstatus[i] = float(o_orderstatus_arr[i])
        o_orderkey[i] = float(o_orderkey_arr[i])
    ...
    var orders_col_data = List[Float64Array]()
    orders_col_data.append(o_orderstatus)
    orders_col_data.append(o_orderkey)
    

    var orders_col1_name = "o_orderstatus"
    var orders_col2_name = "orderkey"
...
fn test_query_22() raises:
    ...
    for i in range(450000):
        c_phone[i] = str(c_phone_arr[i])
    
    var c_custkey = Float64Array("c_custkey_tensor")
    var c_nationkey = Float64Array("c_nationkey_tensor")
    var c_acctbal = Float64Array("c_acctbal_tensor")
    ...
    var o_custkey = Float64Array("o_custkey_tensor")
    var o_orderkey = Float64Array("o_orderkey_tensor")
