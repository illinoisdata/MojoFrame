...
from core.Calculations import (
    ...
    filter_string_endwith,
    filter_string_startwith,
    filter_not_string_exists_before,
    filter_string_not_equal_mask,
    filter_string_not_startwith_mask,
    filter_f64_IN_mask,
    evaluate_i32,
    evaluate_f64,
    evaluate_f64_mask,
